...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        public int SleepTime { get; set; } // added. Exercise 2
        ...
        public Engine(IRenderer renderer, IUserInterface userInterface)
        {
            ...
            this.SleepTime = 500; // added. Exercise 2
        }
        // added. Exercise 2
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            this.allObjects.RemoveAll(x => x is Racket); //added. Exercise 3
            this.staticObjects.RemoveAll(x => x is Racket); //added. Exercise 3
